...
class EfficientUnet(nn.Module):
    def __init__(self, N_action=27, concat_input=True):
        ...
        self.encoder = EfficientNet.encoder('efficientnet-b1', pretrained=False)
    ...
    def forward(self, x):
        ...
        # print("shape of h_p:"+str(h_p.shape))
        #ht1 = pad_or_not(h_p,ht1)
        # print("shape of h_p:"+str(ht1.shape))
        ...
        # print("shape of ht_2:"+str(ht2.shape))
        # print("shape of h_p:"+str(h_p.shape))
        #ht2 = pad_or_not(h_p,ht2)
        # print("shape of h_p:"+str(ht2.shape))
